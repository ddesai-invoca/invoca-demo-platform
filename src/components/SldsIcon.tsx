/* =============================================================================
   ...
   ⚠️ THE LOGO AND THE AVATAR ARE NOT HERE, and that is deliberate: both turned out to be
   real assets after all — CSS `background-image`s on `.slds-global-header__logo` (200x40) and
   `.profileTrigger` (32 square). Two passes wrongly concluded "not in the capture" because
   they searched for `<img>` and `<svg>` and filtered corner elements by width. **When a mark
   seems absent from a capture, check `background-image` across the region before authoring
   one.** They are now files under `public/icons/salesforce/` and styled in CSS.
...
const PATHS: Record<string, string> = {
  ...
  /* Invoca Call Log list view, all four extracted verbatim from that capture. */
  pin: "M369 237h-5L330 79h9a29 29 0 000-58H181a29 29 0 000 58h9l-33 158h-5a29 29 0 000 58h84v174c0 16 13 30 30 30s30-13 30-30V296h74c16 0 29-13 29-29s-14-30-30-30",
  listdisplay: "M465 20H55c-8 0-15 7-15 15v50c0 8 7 15 15 15h410c8 0 15-7 15-15V35c0-8-7-15-15-15M145 140H55c-8 0-15 7-15 15v30c0 8 7 15 15 15h90c8 0 15-7 15-15v-30c0-8-7-15-15-15m160 0h-90c-8 0-15 7-15 15v30c0 8 7 15 15 15h90c8 0 15-7 15-15v-30c0-8-7-15-15-15m160 0h-90c-8 0-15 7-15 15v30c0 8 7 15 15 15h90c8 0 15-7 15-15v-30c0-8-7-15-15-15M145 240H55c-8 0-15 7-15 15v30c0 8 7 15 15 15h90c8 0 15-7 15-15v-30c0-8-7-15-15-15m160 0h-90c-8 0-15 7-15 15v30c0 8 7 15 15 15h90c8 0 15-7 15-15v-30c0-8-7-15-15-15m160 0h-90c-8 0-15 7-15 15v30c0 8 7 15 15 15h90c8 0 15-7 15-15v-30c0-8-7-15-15-15M145 340H55c-8 0-15 7-15 15v30c0 8 7 15 15 15h90c8 0 15-7 15-15v-30c0-8-7-15-15-15m160 0h-90c-8 0-15 7-15 15v30c0 8 7 15 15 15h90c8 0 15-7 15-15v-30c0-8-7-15-15-15m160 0h-90c-8 0-15 7-15 15v30c0 8 7 15 15 15h90c8 0 15-7 15-15v-30c0-8-7-15-15-15M145 440H55c-8 0-15 7-15 15v30c0 8 7 15 15 15h90c8 0 15-7 15-15v-30c0-8-7-15-15-15m160 0h-90c-8 0-15 7-15 15v30c0 8 7 15 15 15h90c8 0 15-7 15-15v-30c0-8-7-15-15-15m160 0h-90c-8 0-15 7-15 15v30c0 8 7 15 15 15h90c8 0 15-7 15-15v-30c0-8-7-15-15-15",
  sortarrows: "M275 160c6-6 6-15 0-21L161 24c-6-6-15-6-21 0L25 139c-6 6-6 15 0 21l21 21c6 6 15 6 21 0l36-36c6-6 17-2 17 7v212c0 8 7 15 15 15h30c8 0 15-8 15-15V152c0-9 11-13 17-7l36 36c6 6 15 6 21 0zm220 200l-21-20c-6-6-15-6-21 0l-36 36c-6 6-17 2-17-7V155c0-8-7-15-15-15h-30c-8 0-15 8-15 15v212c0 9-11 13-17 7l-36-36c-6-6-15-6-21 0l-21 22c-6 6-6 15 0 21l115 115c6 6 15 6 21 0l115-115c5-6 5-16-1-21",
  piechart: "M455 234L250 347a20 20 0 01-30-18V84c0-10-10-18-19-15a220 220 0 10276 175c-2-10-13-15-22-10m-178 46l197-105c12-6 16-22 8-33A302 302 0 00287 22c-14-3-27 8-27 22v226c0 9 9 14 17 10",
  /* ⚠️ THE CHECKED AND UNCHECKED STATES OF A READ-ONLY CHECKBOX, both extracted verbatim
     from the Invoca Call Log record page, both 16px at fill `#181818`. The unchecked one is
     NOT an empty box and not a missing icon: it is a DASHED square, which is what the
     record page draws for a signal that did not fire. Rendering nothing there would make an
     unfired signal indistinguishable from a field the page failed to draw. */
  check: "M191 425L26 259c-6-6-6-16 0-22l22-22c6-6 16-6 22 0l124 125a10 10 0 0015 0L452 95c6-6 16-6 22 0l22 22c6 6 6 16 0 22L213 425c-6 7-16 7-22 0",
  checkboxdash: "M444 502h-70v-48h70zm-141 0h-70v-48h70zm-140 0H93v-48h70zm-94-59H21v-70h48zm430-17h-48v-70h48zM69 303H21v-70h48zm430-17h-48v-70h48zM69 163H21V93h48zm430-16h-48V77h48zm-73-81h-70V18h70zm-140 0h-70V18h70zm-139 0H77V18h70z",
