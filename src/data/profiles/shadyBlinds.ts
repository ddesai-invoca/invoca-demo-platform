...
export const shadyBlinds: CustomerProfile = {
  ...
  reports: {
    digitalInsights: {
      ...
      chart: [
        { date: "Jan 1-4", value: 7635 },
        { date: "Jan 5-11", value: 13913 },
        { date: "Jan 12-18", value: 14188 },
        { date: "Jan 19-25", value: 13775 },
        { date: "Jan 26-31", value: 11689 },
      ],
      dimensionColumns: [
    ...
    marketingDashboard: {
      ...
      kpiGroups: [
        { title: "Call Performance Summary", tiles: [
          { label: "Call Count", value: "48,000" },
          { label: "Sales Call (Percent)", value: "84%" },
          { label: "Purchase (Percent)", value: "25%" },
          { label: "Total Revenue (Sale Amount)", value: "$37,800,000" },
        ]},
        { title: "Non-Sales Inquiries", tiles: [
          { label: "Call Count", value: "7,680" },
      ...
      breakdowns: [
        { title: "Calls by Source", tableTitle: "Source: Call Outcome Summary", dimensionColumn: "Marketing Source", hasDonut: true,
          ...
          rows: [
            { name:"Paid Search", metrics:["21,600","51%","16%","$9,726,570"] },
            { name:"Social Media", metrics:["9,600","54%","19%","$4,822,600"] },
            { name:"Organic", metrics:["7,200","64%","33%","$7,686,750"] },
            { name:"Print", metrics:["5,400","59%","26%","$3,770,120"] },
            { name:"Email", metrics:["4,200","93%","71%","$11,793,960"] },
          ]},
        { title: "Calls by Medium", tableTitle: "Medium: Call Outcome Summary", dimensionColumn: "Marketing Medium", hasDonut: true,
          metricColumns: ["Call Count","Quote Discussed (Percent)","Purchase (Percent)","Total Revenue (Sale Amount)"],
          rows: [
            { name:"cpc", metrics:["15,595","49%","13%","$5,835,942"] },
            { name:"Organic", metrics:["7,200","64%","33%","$7,686,750"] },
            { name:"Bing", metrics:["6,005","56%","23%","$3,890,628"] },
            { name:"Brochure", metrics:["5,400","59%","26%","$3,770,120"] },
            { name:"Facebook", metrics:["5,299","52%","18%","$2,459,526"] },
            { name:"Instagram", metrics:["4,301","55%","21%","$2,363,074"] },
            { name:"SFMC", metrics:["4,200","93%","71%","$11,793,960"] },
          ]},
        { title: "Calls by Campaign", tableTitle: "Campaign: Call Outcome Summary", dimensionColumn: "Marketing Campaign", hasDonut: true,
          metricColumns: ["Call Count","Quote Discussed (Percent)","Purchase (Percent)","Total Revenue (Sale Amount)"],
          rows: [
            { name:"Summer Shade Event", metrics:["11,309","50%","14%","$4,172,080"] },
            { name:"The Privacy Project", metrics:["7,142","55%","21%","$4,094,380"] },
            { name:"Design Before You Decide", metrics:["5,357","59%","27%","$4,172,410"] },
            { name:"Block It Out", metrics:["3,571","68%","38%","$4,269,030"] },
            { name:"Built for Business", metrics:["2,381","90%","67%","$6,728,100"] },
          ]},
        { title: "Calls by Search Term", tableTitle: "Search Term: Call Outcome Summary", dimensionColumn: "Marketing Search Term", hasDonut: true,
          metricColumns: ["Call Count","Quote Discussed (Percent)","Purchase (Percent)","Total Revenue (Sale Amount)"],
          rows: [
            { name:"blinds near me", metrics:["6,528","48%","12%","$1,762,060"] },
            { name:"window blinds cost", metrics:["3,917","52%","17%","$1,604,200"] },
            { name:"plantation shutters for living room", metrics:["2,774","63%","31%","$2,588,830"] },
            { name:"motorized blinds smart home", metrics:["1,958","74%","46%","$3,272,880"] },
            { name:"commercial window treatments quote", metrics:["1,143","97%","77%","$3,624,030"] },
          ]},
        { title: "Conversions by Product Category", tableTitle: "Conversions by Product Category", dimensionColumn: "Product Category", hasDonut: false,
          ...
          rows: [
            { name:"Blinds", metrics:["16,320","40%","17%","$6,985,170"] },
            { name:"Shades", metrics:["12,480","43%","22%","$7,824,390"] },
            { name:"Shutters", metrics:["10,080","47%","28%","$10,978,760"] },
            { name:"Drapes", metrics:["5,760","49%","32%","$5,629,730"] },
            { name:"Services", metrics:["3,360","63%","56%","$6,381,950"] },
          ]},
        { title: "Calls by Line of Business", tableTitle: "Line of Business: Summary", dimensionColumn: "Line Of Business", hasDonut: true,
          metricColumns: ["Call Count","Quote Discussed (Percent)","Purchase (Percent)","Total Revenue (Sale Amount)"],
          rows: [
            { name:"Residential", metrics:["39,360","55%","21%","$22,475,220"] },
            { name:"Commercial", metrics:["8,640","72%","44%","$15,324,780"] },
          ]},
        { title: "Calls by Region", tableTitle: "Region Summary", dimensionColumn: "Location Region", hasDonut: true,
          metricColumns: ["Call Count","Quote Discussed (Percent)","Purchase (Percent)","Total Revenue (Sale Amount)"],
          rows: [
            { name:"South", metrics:["14,400","53%","19%","$7,768,980"] },
            { name:"Midwest", metrics:["11,520","56%","22%","$7,271,380"] },
            { name:"West", metrics:["10,080","58%","25%","$8,046,590"] },
            { name:"Northeast", metrics:["7,680","60%","27%","$7,045,030"] },
            { name:"Great Lakes", metrics:["4,320","77%","50%","$7,668,020"] },
          ]},
        { title: "Call by Division", tableTitle: "Division Summary", dimensionColumn: "Location Division", hasDonut: true,
          metricColumns: ["Call Count","Quote Discussed (Percent)","Purchase (Percent)","Total Revenue (Sale Amount)"],
          rows: [
            { name:"South Atlantic", metrics:["10,906","52%","17%","$5,075,490"] },
            { name:"Pacific", metrics:["8,179","55%","21%","$5,473,560"] },
            { name:"East North Central", metrics:["6,475","58%","25%","$4,595,620"] },
            { name:"Middle Atlantic", metrics:["5,112","61%","29%","$4,845,370"] },
            { name:"West South Central", metrics:["3,408","80%","54%","$6,847,960"] },
          ]},
      ],
      salesCallBreakoutGraph: {
        ...
        series: [
          { name: "Sales Call (Count)", values: [4773,8806,9260,9623,7858] },
          { name: "Quote Discussed (Count)", values: [3211,5994,6431,6744,5460] },
          { name: "Unqualified Lead (Count)", values: [1716,2889,2804,2691,2380] },
          { name: "Purchase (Count)", values: [1348,2547,2788,2949,2368] },
        ],
      },
      productCategoryGraph: {
        ...
        xLabels: ["Jan 1-4","Jan 5-11","Jan 12-18","Jan 19-25","Jan 26-31"],
        series: [
          { name: "Blinds", values: [331,610,642,667,544] },
          { name: "Shades", values: [319,589,620,644,526] },
          { name: "Shutters", values: [333,615,646,672,549] },
          { name: "Drapes", values: [215,397,417,433,354] },
          { name: "Services", values: [222,410,431,448,366] },
        ],
      },
    },
    callReview: {
      shownCount: "15 Calls",
      totalNote: "total of 48,000 calls from Jan 1 to Jan 31",
    ...
    opsDashboard: {
      ...
      kpiGroups: [
        { title: "MARKETING DRIVEN CALLS", tiles: [
          ...
          { label: "Avg. Revenue (Sale Amount)", value: "$787.50" },
          { label: "Total Revenue (Sale Amount)", value: "$37,800,000" },
        ]},
        { title: "NEW CUSTOMER ACQUISITION", tiles: [
          { label: "Caller Type: New Customers (Count)", value: "35,040" },
          { label: "Caller Type: New Customers (Percent)", value: "73%" },
          { label: "Consultation: Scheduled (Count)", value: "21,600" },
          { label: "Consultation: Scheduled (Percent)", value: "45%" },
        ]},
        { title: "EXISTING CUSTOMERS & RESCHEDULING", tiles: [
          { label: "Caller Type: Existing Customer (Count)", value: "12,960" },
          { label: "Caller Type: Existing Customer (Percent)", value: "27%" },
          { label: "Consultation: Canceled (Count)", value: "1,944" },
      ...
      marketingSections: [
        {
          ...
          table: {
            ...
            rows: [
              { cells: ["Paid Search","21,600","39%","$9,726,570"] },
              { cells: ["Social Media","9,600","41%","$4,822,600"] },
              { cells: ["Organic","7,200","50%","$7,686,750"] },
              { cells: ["Print","5,400","46%","$3,770,120"] },
              { cells: ["Email","4,200","76%","$11,793,960"] },
            ],
          },
        },
        {
          ...
          chart: { legend: "Call Count", axisMax: 16000, axisTicks: [0,4000,8000,12000,16000], axisSuffix: "",
            bars: [
              { name: "cpc", value: 15595, display: "15,595" },
              { name: "Organic", value: 7200, display: "7,200" },
              { name: "Bing", value: 6005, display: "6,005" },
              { name: "Brochure", value: 5400, display: "5,400" },
              { name: "Facebook", value: 5299, display: "5,299" },
              { name: "Instagram", value: 4301, display: "4,301" },
            ] },
          ...
          table: {
            ...
            rows: [
              { cells: ["cpc","15,595","37%"] },
              { cells: ["Organic","7,200","50%"] },
              { cells: ["Bing","6,005","43%"] },
              { cells: ["Brochure","5,400","46%"] },
              { cells: ["Facebook","5,299","40%"] },
              { cells: ["Instagram","4,301","42%"] },
            ],
          },
        },
        {
          ...
          chart: { legend: "Call Count", axisMax: 12000, axisTicks: [0,3000,6000,9000,12000], axisSuffix: "",
            bars: [
              { name: "Summer Shade Event", value: 11309, display: "11,309" },
              { name: "The Privacy Project", value: 7142, display: "7,142" },
              { name: "Design Before You Decide", value: 5357, display: "5,357" },
              { name: "Block It Out", value: 3571, display: "3,571" },
              { name: "Built for Business", value: 2381, display: "2,381" },
            ] },
          ...
          table: {
            ...
            rows: [
              { cells: ["Summer Shade Event","11,309","38%","$4,172,080"] },
              { cells: ["The Privacy Project","7,142","42%","$4,094,380"] },
              { cells: ["Design Before You Decide","5,357","46%","$4,172,410"] },
              { cells: ["Block It Out","3,571","54%","$4,269,030"] },
              { cells: ["Built for Business","2,381","73%","$6,728,100"] },
            ],
          },
        },
        {
          ...
          chart: { legend: "Call Count", axisMax: 7000, axisTicks: [0,1750,3500,5250,7000], axisSuffix: "",
            bars: [
              { name: "blinds near me", value: 6528, display: "6,528" },
              { name: "window blinds cost", value: 3917, display: "3,917" },
              { name: "plantation shutters for living room", value: 2774, display: "2,774" },
              { name: "motorized blinds smart home", value: 1958, display: "1,958" },
              { name: "commercial window treatments quote", value: 1143, display: "1,143" },
            ] },
      ...
      webpages: {
        ...
        rows: [
              { cells: ["Blinds","16,320","40%","74%"] },
              { cells: ["Shades","12,480","43%","71%"] },
              { cells: ["Shutters","10,080","47%","76%"] },
              { cells: ["Drapes","5,760","49%","72%"] },
              { cells: ["Services","3,360","63%","78%"] },
        ],
      },
      ...
      locationHandling: {
        ...
        rows: [
              { cells: ["Downtown Showroom","14,400","1,210","5%","42%"] },
              { cells: ["Westside Design Center","11,520","980","5%","45%"] },
              { cells: ["North Valley Showroom","9,600","845","6%","40%"] },
              { cells: ["Harbor Point Studio","7,200","520","4%","49%"] },
              { cells: ["Riverside Gallery","5,280","285","3%","56%"] },
        ],
      },
      noBookingChart: {
        yLabel: "Call Count",
        xLabels: ["Jan 1-4","Jan 5-11","Jan 12-18","Jan 19-25","Jan 26-31"],
        series: [
          { name: "Price Above Budget", values: [1209,2054,2014,1973,1726] },
          { name: "Comparing Providers", values: [866,1546,1562,1577,1313] },
          { name: "Timing Not Right", values: [587,1059,1080,1101,925] },
          { name: "Needs Partner Approval", values: [443,775,775,775,664] },
          { name: "Outside Service Area", values: [313,538,532,527,466] },
        ],
      },
    },
    aiAgentConversion: {
      ...
      conversionCards: [
        ...
        { title: "LEAD FORM (Conversions): SMS Agent & Live Agent", chips: ["Interaction Type: Form Fill", "SMS Agent Engaged: Yes", "Live Agent Call: Yes"],
          tiles: [{ label: "Job Complete (Percent)", value: "51%" }, { label: "Total Revenue (Sale Amount)", value: "$4,093,056" }] },
        { title: "LEAD FORM (Conversions): SMS Agent Assist", chips: ["Interaction Type: Form Fill", "SMS Agent Engaged: Yes", "Live Agent Call: No"],
          tiles: [{ label: "Job Complete (Percent)", value: "70%" }, { label: "Total Revenue (Sale Amount)", value: "$3,123,648" }] },
        { title: "Voice Agent (Conversions): Live Agent", chips: ["Interaction Type: Voice", "Voice Agent Engaged: No", "Live Agent Call: Yes"],
          tiles: [{ label: "Job Complete (Percent)", value: "24%" }, { label: "Total Revenue (Sale Amount)", value: "$2,585,088" }] },
        { title: "Voice Agent (Conversions): Voice Agent & Live Agent", chips: ["Interaction Type: Voice", "Voice Agent Engaged: Yes", "Live Agent Call: Yes"],
          tiles: [{ label: "Job Complete (Percent)", value: "58%" }, { label: "Total Revenue (Sale Amount)", value: "$4,523,904" }] },
        { title: "Voice Agent (Conversions): Voice Agent", chips: ["Interaction Type: Voice", "Voice Agent Engaged: Yes", "Live Agent Call: No"],
          tiles: [{ label: "Job Complete (Percent)", value: "78%" }, { label: "Total Revenue (Sale Amount)", value: "$4,739,328" }] },
      ],
      breakdowns: [
        {
          ...
          hasDonut: true, donutTotal: 19200,
          rows: [
            { name: "Paid Search", metrics: ["8,640", "48%", "21%", "$5,618,840"] },
            { name: "Social Media", metrics: ["3,840", "51%", "26%", "$2,787,460"] },
            { name: "Organic", metrics: ["2,880", "63%", "44%", "$4,441,390"] },
            { name: "Print", metrics: ["2,160", "57%", "35%", "$2,177,860"] },
            { name: "Email", metrics: ["1,680", "93%", "91%", "$6,516,850"] },
          ],
        },
        {
          ...
          hasDonut: true, donutTotal: 19200,
          rows: [
            { name: "cpc", metrics: ["6,238", "46%", "17%", "$3,373,130"] },
            { name: "Organic", metrics: ["2,880", "63%", "44%", "$4,441,340"] },
            { name: "Bing", metrics: ["2,402", "54%", "30%", "$2,248,750"] },
            { name: "Brochure", metrics: ["2,160", "57%", "35%", "$2,177,830"] },
            { name: "Facebook", metrics: ["2,120", "50%", "24%", "$1,420,510"] },
            { name: "Instagram", metrics: ["1,720", "53%", "28%", "$1,364,070"] },
            { name: "SFMC", metrics: ["1,680", "93%", "91%", "$6,516,770"] },
          ],
        },
        {
          ...
          hasDonut: true, donutTotal: 19200,
          rows: [
            { name: "Summer Shade Event", metrics: ["4,524", "46%", "18%", "$2,377,088"] },
            { name: "The Privacy Project", metrics: ["2,857", "52%", "27%", "$2,333,670"] },
            { name: "Design Before You Decide", metrics: ["2,143", "58%", "35%", "$2,379,050"] },
            { name: "Block It Out", metrics: ["1,428", "67%", "50%", "$2,431,430"] },
            { name: "Built for Business", metrics: ["952", "92%", "89%", "$3,835,050"] },
          ],
        },
        {
          ...
          hasDonut: true, donutTotal: 19200,
          rows: [
            { name: "blinds near me", metrics: ["2,611", "45%", "16%", "$1,036,856"] },
            { name: "window blinds cost", metrics: ["1,567", "50%", "23%", "$944,760"] },
            { name: "plantation shutters for living room", metrics: ["1,110", "62%", "42%", "$1,524,990"] },
            { name: "motorized blinds smart home", metrics: ["783", "75%", "63%", "$1,925,030"] },
            { name: "commercial window treatments quote", metrics: ["457", "94%", "92%", "$1,892,780"] },
          ],
        },
        {
          ...
          hasDonut: false,
          rows: [
            { name: "Blinds", metrics: ["6,528", "49%", "23%", "$3,980,310"] },
            { name: "Shades", metrics: ["4,992", "53%", "29%", "$4,460,630"] },
            { name: "Shutters", metrics: ["4,032", "58%", "37%", "$6,255,570"] },
            { name: "Drapes", metrics: ["2,304", "62%", "42%", "$3,208,950"] },
            { name: "Services", metrics: ["1,344", "82%", "74%", "$3,636,940"] },
          ],
        },
      ],
      productCategoryGraph: {
        ...
        xLabels: ["Jan 1-4","Jan 5-11","Jan 12-18","Jan 19-25","Jan 26-31"],
        series: [
          { name: "Blinds", values: [175,322,339,352,287] },
          { name: "Shades", values: [169,311,327,340,278] },
          { name: "Shutters", values: [176,325,341,355,289] },
          { name: "Drapes", values: [114,209,220,229,187] },
          { name: "Services", values: [117,216,228,237,193] },
        ],
      },
    },
    ...
    aiMessagingImpact: {
      ...
      aiLeadEngagement: {
        ...
        tiles: [
          { label: "Form Submits", value: "24,800" },
      ...
      aiAppointmentPerformance: {
        ...
        tiles: [
          ...
          { label: "Consultation Scheduled (Count)", value: "5,704" },
          { label: "Total Revenue (Sale Amount)", value: "$19,393,600" },
        ],
      },
      humanLeadEngagement: {
        ...
        chip: "Last Month",
        tiles: [
          { label: "Form Submits", value: "21,600" },
      ...
      humanAppointmentPerformance: {
        ...
        tiles: [
          ...
          { label: "Consultation Scheduled (Count)", value: "648" },
          { label: "Total Revenue (Sale Amount)", value: "$2,041,200" },
        ],
      },
      ...
      trendChart: {
        ...
        series: [
          { name: "Consultation Scheduled", values: [96,101,94,99,103,97,100,95,102,98,104,140,195,226,233,226,235,228,238,231,240,233,242,235,244,238,247,240,249,242,253] },
        ],
      },
      aiOpportunities: {
        title: "AI-Assisted Opportunities",
        tiles: [
          { label: "SMS Opt-In Count", value: "21,576" },
          { label: "SMS Opt-In Rate", value: "87%" },
          { label: "Total Messages", value: "194,184" },
        ],
      },
      aiLeadNurture: {
        title: "AI Lead Nurture",
        tiles: [
          { label: "AI SMS Callback Scheduled (Count)", value: "12,614" },
          { label: "AI SMS Callback Scheduled (Percent)", value: "58%" },
          { label: "AI SMS Callback Completed (Count)", value: "12,298" },
      ...
      commonTopicsChart: {
        ...
        xLabels: ["Jan 1-4","Jan 5-11","Jan 12-18","Jan 19-25","Jan 26-31"],
        series: [
          { name: "Blinds", values: [230,423,445,463,378] },
          { name: "Shades", values: [176,324,341,354,288] },
          { name: "Shutters", values: [142,262,275,286,233] },
          { name: "Drapes", values: [81,149,157,163,134] },
          { name: "Motorization", values: [47,87,92,95,79] },
        ],
      },
    },
    ...
    conversationIntelligence: {
      ...
      dateRange: "Jan 1, 2026 - Jan 31, 2026",
      callCount: "48,000 calls",
      pagerLabel: "1 of 4,800",
      calls: [
    ...
    smsConversationIntelligence: {
      countLabel: "18,240 conversations",
      dateRange: "Jan 1, 2026 - Jan 31, 2026",
      pagerLabel: "1 of 1,824",
      conversations: [
        {
    ...
    qualityManagement: {
      ...
      salesOpportunities: {
        ...
        tiles: [
          { label: "Call Count", value: "44,160" },
          { label: "Buying Intent (Industry) (Count)", value: "26,496" },
        ],
      },
      salesConversions: {
        ...
        chips: ["2 Filters"],
        tiles: [
          { label: "Consultation Booked (Count)", value: "21,600" },
          { label: "Total Revenue (Sale Amount)", value: "$37,800,000" },
        ],
      },
      callsNeedingReview: {
        ...
        chart: {
          ...
          axisSuffix: "",
          bars: [
            { name: "Joshua Young", value: 246, display: "246" },
            { name: "Olivia King", value: 238, display: "238" },
            { name: "Michael Thompson", value: 231, display: "231" },
            { name: "James Reynolds", value: 224, display: "224" },
            { name: "Lauren Sanchez", value: 216, display: "216" },
          ],
        },
      },
      highestConvertingAgents: {
        ...
        xLabels: ["Jan 1-4","Jan 5-11","Jan 12-18","Jan 19-25","Jan 26-31"],
        series: [
          { name: "Victoria Murphy", values: [120,221,232,242,197] },
          { name: "Jessica Roberts", values: [114,209,220,229,187] },
          { name: "Sophia Bennett", values: [114,211,222,231,188] },
          { name: "Emily Davis", values: [105,193,203,211,173] },
          { name: "Daniel Wright", values: [107,197,207,215,175] },
        ],
      },
      baselineSkills: {
      ...
      bottomByAgentTable: {
        ...
        table: {
          ...
          rows: [
            { cells: ["Joshua Young", "52.4%", "26%", "$628,250", "1,380"] },
            { cells: ["Olivia King", "54.1%", "28%", "$698,250", "1,425"] },
            { cells: ["Michael Thompson", "55.8%", "30%", "$768,250", "1,462"] },
            { cells: ["James Reynolds", "57.3%", "31%", "$763,000", "1,408"] },
            { cells: ["Lauren Sanchez", "59.0%", "33%", "$862,750", "1,494"] },
            { cells: ["Samantha Foster", "60.6%", "35%", "$883,750", "1,443"] },
          ],
        },
      },
      topByAgentBar: {
      ...
      qualityByAgentTable: {
        ...
        table: {
          columns: ["Agent", "New Customer Sales Combination Scorecard (Average)", "Consultation Booked (Percent)", "Total Revenue (Sale Amount)", "Call Count"],
          rows: [
            { cells: ["Victoria Murphy", "93.8%", "67%", "$1,771,000", "1,510"] },
            { cells: ["Jessica Roberts", "92.5%", "65%", "$1,678,250", "1,476"] },
            { cells: ["Sophia Bennett", "91.1%", "63%", "$1,690,500", "1,533"] },
            { cells: ["Emily Davis", "89.7%", "61%", "$1,548,750", "1,451"] },
            { cells: ["Daniel Wright", "88.4%", "60%", "$1,576,750", "1,502"] },
            { cells: ["Brian Walker", "87.0%", "58%", "$1,489,250", "1,468"] },
          ],
        },
      },
      trendingToConversion: {
        ...
        points: qmDays(71, 8, 697, 90, true, 21600),
      },
      trendingToRevenue: {
        ...
        points: qmDays(71, 8, 1219355, 160000, true, 37800000),
      },
    },
    ...
    qmInstantInsights: {
      ...
      essentialMetrics: {
        ...
        tiles: [
          ...
          { label: "Not Answered by Agent (Count)", value: "3,840" },
          { label: "Negative Sentiment (Count)", value: "2,880" },
        ],
      },
      trendingAnswerRate: {
      ...
      evaluationRollup: {
        ...
        chips: [],
        tiles: [
          { label: "Introduction (Average)", value: "84.67%" },
          { label: "Phone Etiquette (Average)", value: "88.88%" },
          { label: "Problem Resolution (Average)", value: "71.84%" },
        ],
      },
      scoredCallsByEvaluator: {
        ...
        table: {
          ...
          rows: [
            { cells: ["Kathy Bui", "412", "88.4%", "91.2%", "74.6%"] },
            { cells: ["Sarah Weingart", "386", "84.1%", "88.7%", "71.3%"] },
            { cells: ["Brandon McCarty", "254", "79.5%", "85.4%", "68.2%"] },
          ],
        },
      },
    },
